...
function draw() {
  ...
  if(gameState==="home"){
    ...
    fill("white");
    text("Nayan's Helping Hand",400,50);
     
    textSize(20);
    text("Rules:",100,100);
    text("1.In level 1, move using arrow keys. ",100,200);
    text("Aim of level 1: Collect 7 items from the room to earn 70 points.",90,300);
    text("2. In level 2, knife moves with the mouse.",100,400);
    text("Aim of level 2: Cut fruits and score 20 points.",100,500);
...
if(gameState==="End"){
  ...
  text("Refresh page to play again !!",500,300);
  textSize(10);
  text("Created by Nayan P Raj😃",1000,450);
}
